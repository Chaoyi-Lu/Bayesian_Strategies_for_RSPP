...
SPP_Parallel_Noisy_MH <- function(Y, beta0, gamma0, eps_beta, eps_gamma, R, N, T){ 
...
dppG_Parallel_Noisy_MH <- function(Y, tau0, sigma0, eps_tau, eps_sigma, N, T){ # tau0: initial tau, sigma0: initial sigma, 
  # Y: N X 2 observed data, the ith row is the ith point
  # tau0: initial tau
  # sigma0: initial sigma, 
  # eps_tau: Proposal epsilon of tau
...
Approx_dppG_Parallel_Noisy_MH <- function(Y, tau0, sigma0, eps_tau, eps_sigma, N, T){
  # Y: N X 2 observed data, the ith row is the ith point
  # tau0: initial tau
  # sigma0: initial sigma, 
  # eps_tau: Proposal epsilon of tau
...
df_SPP_Parallel_Noisy_MH <- function(Y, beta0, gamma0, eps_beta, eps_gamma, R, N, T){ # beta0: initial beta, gamma0: initial gamma, 
  # Y: N X 2 observed data, the ith row is the ith point
  # beta0: initial beta
  # gamma0: initial gamma, 
  # eps_beta: Proposal epsilon of beta
